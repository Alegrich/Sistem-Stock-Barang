...
class StockInController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('stockin')->with('success', 'Stock In created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('stockin')->with('success', 'Stock In updated successfully.');
    }

    public function destroy($id)
    {
        StockIn::find($id)->delete();
        return redirect()->route('stockin')->with('success', 'Stock In deleted successfully.');
    }
}