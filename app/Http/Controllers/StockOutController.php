...
class StockoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('stockout')->with('success', 'Stock In created successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('stockout')->with('success', 'Stock In updated successfully.');
    }

    public function destroy($id)
    {
        Stockout::find($id)->delete();
        return redirect()->route('stockout')->with('success', 'Stock In deleted successfully.');
    }
}