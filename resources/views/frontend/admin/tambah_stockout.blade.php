...
@section('main', 'Tambah Stock In')

@section('location')
    <div class="breadcrumb-item"><a href="{{ route('stockout') }}">Stock In</a></div>
    <div class="breadcrumb-item">Tambah Stock In</div>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-0 shadow rounded">
                <div class="card-body">
                    <form action="{{ route('store_stockout') }}" method="POST">
                        @csrf
